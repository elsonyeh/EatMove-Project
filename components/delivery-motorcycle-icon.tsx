...
interface DeliveryMotorcycleIconProps extends React.SVGProps<SVGSVGElement> {}

export const DeliveryMotorcycleIcon: React.FC<DeliveryMotorcycleIconProps> = (props) => {
  return (
